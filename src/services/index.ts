...
export { configService, type SkillOrgEntry } from './configService';
export type { Settings, IDEConfig } from '@/types/ide';
...
export { storageService, type LibraryData, type SyncState, type SkillEntry } from './storageService';
export type { AppConfig } from '@/types/ide';
